...
bricks_m    db 'BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB'
            db 'B                              B'
            db 'B                              B'
            db 'B                              B'
            db 'B                              B'
...
spring_m    db 'SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS'
            db 'S                              S'
            db 'S                              S'
            db 'S                              S'
            db 'S                              S'
...
portal_m    db 'PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP'
            db 'P                              P'
            db 'P                              P'
            db 'P                              P'
            db 'P                              P'
...
easy_map    db 'PBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBP'
            db 'P                              P'
            db 'P                              P'
            db 'P                              P'
            db 'P                              P'
...
medium      db 'BSSSSSSSSSSSSSSSSSSSBPPPPPPPPPPB'
            db 'B                   B          B'
            db 'B                   B          B'
            db 'B                   B          B'
            db 'B                   B          B'
...
hard    db 'BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB'
        db 'BSSPPPPPPPPPPPPPPPPPPPPPPPPPPPPB'
        db 'B         S          S         B'
        db 'B              S         S     B'
        db 'B  PPPPPPPPPPPPPPPPPPPPPPPPPPPPB'
        db 'B                              B'
        db 'B                              B'
        db 'BSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSB'
        db 'B                             SB'
        db 'BS                            SB'
        db 'BS                            SB'
        db 'B                             SB'
        db 'BSSBBBBBBBBBBBBBBBBBB  BBBBBBBBB'
        db 'B                      BSSSSSSSB'
        db 'B  BBBBBBBBBBBBBBBBBBBBB       B'
        db 'B                              B'
        db 'BBBBBBBBBBBBBBB BBBBBBBBBBBBBBBB'
        db 'B             B B              B'
        db 'B                              B'
        db 'BBBPPPPPPPPPPPPPPPPPPPPPPPPPPPPB'


all_maps dw bricks_m, spring_m, portal_m, easy_map, medium, hard
